...
{
    [Serializable]
    public class srv_get_pidResponse : Message
    {
        ...
        public srv_get_pidResponse(long pid_id, double p_value, double i_value, double d_value, double setpoint)
        {
            this.pid_id = pid_id;
        ...
        public static srv_get_pidResponse Deserialize(MessageDeserializer deserializer) => new srv_get_pidResponse(deserializer);

        private srv_get_pidResponse(MessageDeserializer deserializer)
        {
