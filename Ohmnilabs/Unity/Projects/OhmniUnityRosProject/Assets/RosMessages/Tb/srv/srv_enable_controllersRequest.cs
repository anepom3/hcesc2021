...
{
    [Serializable]
    public class srv_enable_controllersRequest : Message
    {
        ...
        public srv_enable_controllersRequest()
        {
        ...
        public srv_enable_controllersRequest(bool enable_controller, bool pid_velocity_motor_left, bool pid_velocity_motor_right)
        {
        ...
        public static srv_enable_controllersRequest Deserialize(MessageDeserializer deserializer) => new srv_enable_controllersRequest(deserializer);

        private srv_enable_controllersRequest(MessageDeserializer deserializer)
        {
        ...
        {
            return "srv_enable_controllersRequest: " +
